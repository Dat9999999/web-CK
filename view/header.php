...
<head>
    ...
    <link rel="stylesheet" href="./view/asset/font/fontawesome-free-6.5.1-web/css/all.min.css" />
    <script src="https://kit.fontawesome.com/a076d05399.js" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="./view/asset/css/" />
    <link rel="stylesheet" href="./view/asset/css/header.css" />
...
<body>
    <div class="Home">
        <div class="sidebar">
            ...
            <div class="menu">
                ...
                <div class="menu-item" id="khachhang">
                    ...
                    <a href="index.php?pg=customer">Tra Cứu Khách Hàng</a>
                </div>
                <div class="menu-item" id="khachhang">
                    <i class="fa-solid fa-money-check-dollar"></i>
                    <a href="index.php?pg=payment">Thanh Toán</a>
                </div>
        ...
        <div class="header" style="position:fixed;">
            <div class="title">
                <h1><?php echo $_GET['pg']?></h1>
            </div>
            <div class="button">
                <button>
                    <a href="index.php?pg=changePassword" style="color: #fff; text-decoration:none;" class=""> Đổi mật
                        khẩu</a>
                </button>
                <button>
                    <a href="index.php?pg=logout" style="color: #fff; text-decoration:none;" class=""> Đăng xuất</a>
                </button>
            </div>
        </div>
        <!-- Nội dung trang chủ -->
